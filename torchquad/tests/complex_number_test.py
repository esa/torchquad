...
def test_integrate():
    """Tests the compatability with complex numbers for some of the integrate functions."""
    enable_cuda()
    set_precision("double")  # TODO change this to cdouble and change set_precision
    ...
    print("Complex 3D Boole Test: Passed N =", N, "\n", "Errors: ", errors)
    for error in errors:
        assert error < 2e-13
    ...
    # print("Complex 1D VEGAS Test: Passed N =", N, "\n", "Errors: ", errors)
    ...
    # )
    # print("Complex 3D VEGAS Test: Passed N =", N, "\n", "Errors: ", errors)
    # for error in errors:
    #     assert error < 0.61
