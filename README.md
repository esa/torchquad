...
![](https://github.com/esa/torchquad/blob/Add-Benchmark-plots/torchquad_runtime.png?raw=true)
...
![](https://github.com/esa/torchquad/blob/Add-Benchmark-plots/torchquad_convergence.png?raw=true)
