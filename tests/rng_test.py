...
test_edge_cases_tensorflow_f32 = setup_test_for_backend(
    _run_edge_case_tests, "tensorflow", "float32"
)
test_edge_cases_tensorflow_f64 = setup_test_for_backend(
    _run_edge_case_tests, "tensorflow", "float64"
)

test_consistency_numpy_f32 = setup_test_for_backend(
    _run_backend_consistency_tests, "numpy", "float32"
)
test_consistency_numpy_f64 = setup_test_for_backend(
    _run_backend_consistency_tests, "numpy", "float64"
)
test_consistency_torch_f32 = setup_test_for_backend(
    _run_backend_consistency_tests, "torch", "float32"
)
test_consistency_torch_f64 = setup_test_for_backend(
    _run_backend_consistency_tests, "torch", "float64"
)
...
test_consistency_tensorflow_f32 = setup_test_for_backend(
    _run_backend_consistency_tests, "tensorflow", "float32"
)
test_consistency_tensorflow_f64 = setup_test_for_backend(
    _run_backend_consistency_tests, "tensorflow", "float64"
)
